  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1rem", padding: "12px 16px", background: `${season.color}15`, borderRadius: "var(--border-radius-lg)", border: `0.5px solid ${season.color}40` }}>
        ...
        <div style={{ textAlign: "center" }}>
          <p style={{ margin: 0, fontSize: 11, color: "var(--color-text-secondary)" }}>3PT</p>
          <p style={{ margin: 0, fontSize: 20, fontWeight: 500, color: "var(--color-text-primary)" }}>{s.threeM}/{s.threeA}</p>
          <p style={{ margin: 0, fontSize: 11, color: "var(--color-text-secondary)" }}>{s.threeA ? Math.round((s.threeM/s.threeA)*100) : 0}%</p>
        </div>
        <div style={{ textAlign: "right" }}>
          <p style={{ margin: 0, fontSize: 11, color: "var(--color-text-secondary)" }}>AST/TO</p>
          <p style={{ margin: 0, fontSize: 20, fontWeight: 500, color: "var(--color-text-primary)" }}>{s.astToRatio}</p>
        </div>
      </div>
